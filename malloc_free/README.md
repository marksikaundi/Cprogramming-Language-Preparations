...
File 3-alloc_grid.c is a functio pointer to a 2 n that returns adimensional array of integers.
...
File alx.h is a header file contaning all the function prototypes
